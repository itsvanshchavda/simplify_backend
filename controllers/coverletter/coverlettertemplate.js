const coverLetterTemplate = (resume, coverletter, customdata) => {
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <title>${personalInfo.firstName || customdata?.firstName} ${
    personalInfo.lastName || customdata?.lastName
  } - Cover Letter</title>
      ${cssStyles}
    </head>
    <body>
      <div class="a4-paper">
        ...
        <header class="header">
          <div class="full-name">
            ${personalInfo.firstName || customdata?.firstName} ${
    personalInfo.lastName || customdata?.lastName
  }
          </div>
          <div class="contact-info">
            ${
              ...
              <div class="contact-item">
                ...
                <span>${personalInfo.phone || customdata?.phone}</span>
              </div>
            `
                : ""
            }
            ...
            ${
              ...
              <div class="contact-item email-item">
                ...
                <span>${personalInfo.email || customdata?.email}</span>
              </div>
            `
                : ""
            }
        ...
        <div class="letter-body">
          ${formatCoverLetter(coverletter || customdata?.coverletter)}
        </div>
      </div>
    </body>
    </html>
